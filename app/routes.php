...
Route::group(['before' => 'admin'], function() {
    ...
    # Ajax Routes
    Route::get('/admin/lib/get', 'AdminController@getSingleLib');
...
Route::post('/admin/lib/update',  [ 'before' => 'admin', 'uses' => 'AdminController@updateLibrary']);
...
Route::get('/rss', function() {
    ...
    foreach($oLibs as $oLib)
    {
        ...
        $oFeed->item([
            ...
            'link'              => 'https://android-libs.com/lib/' . $oLib->slug
        ]);
    }
