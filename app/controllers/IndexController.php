 ...
 */
    ...
    public static function getSiteMap()
    {
        ...
        $sitemap->add(URL::to('/submit'), '2014-12-10T12:30:00+02:00', '0.7', 'monthly');
        $sitemap->add(URL::to('/login'), '2014-12-10T12:30:00+02:00', '0.7', 'monthly');
        $sitemap->add(URL::to('/register'), '2014-12-10T12:30:00+02:00', '0.7', 'monthly');
