...
class LibraryController extends BaseController
{
    ...
    */
    ...
    function submitLibrary()
    {
        ...
        if(strlen($sInputSubmitterEmail) == 0) {
            return Redirect::to('/submit')->with('error', true)->with('message', 'Please provide your E-Mail address!');
        }
...
/*        $oLibCheck = Libraries::where('url', '=', $sInputUrl)->first();
        ...
        if(strlen($sInputBaseImage) > 0 && Input::has('allowImage'))
        {
