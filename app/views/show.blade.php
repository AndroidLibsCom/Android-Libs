...
@section('title')
<title>AndroidLibs | Libraries and more - {{ $oLib->title }}</title>
@stop

@section('description')
{{ strip_tags($oLib->description) }}
@stop

@section('keywords')
    @if($oLib->hasKeywords())
        {{ trim(str_replace(' ', '', $oLib->title)) }}, {{ $oLib->keywords }}
    @else
        {{ trim(str_replace(' ', '', $oLib->title)) }},android,libraries,libs,dev,developer,list
    @endif
@stop
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="row hidden-xs">
                ...
                <div class="pull-right col-xs-12 col-sm-auto">
                    ...
                    <a href="#" class="btn btn-info sharrre twitter btn-labeled" data-text="I've found this awesome library on Android-Libs! @Android_Libs" data-url="{{ url('/lib/' . $oLib->slug, [], true) }}" data-share="twitter">
                        <span class="btn-label icon fa fa-twitter"></span> Twitter
                    </a>
                    <a href="#" class="btn btn-danger sharrre gplus btn-labeled" data-text="I've found this awesome library on Android-Libs! @Android_Libs" data-url="{{ url('/lib/' . $oLib->slug, [], true) }}" data-share="gplus">
                    ...
                    <div class="row margin-bottom-10">
                        <div class="col-xs-12">
                            @if(Sentry::check())
                                ...
                                @endif
                            @else
                                <a href="{{ url('/login', [], true) }}" class="btn btn-default btn-labeled btn-block">
                                    <span class="btn-label icon fa fa-thumbs-up"></span> Like
                                </a>
                            @endif
                        </div>
                    	...
                    	<div class="col-xs-12">
                    	    <div class="btn-group max-width">
                                ...
                                <ul class="dropdown-menu max-width" role="menu">
                                    <li>
                                        <a href="#" class="sharrre facebook" data-text="I've found this awesome library on Android-Libs! @Android_Libs" data-url="{{ url('/lib/' . $oLib->slug, [], true) }}" data-share="facebook">
                                            <i class="fa fa-fw fa-facebook"></i> Facebook
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="sharrre twitter" data-text="I've found this awesome library on Android-Libs! @Android_Libs" data-url="{{ url('/lib/' . $oLib->slug, [], true) }}" data-share="twitter">
                                            <i class="fa fa-fw fa-twitter"></i> Twitter
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="sharrre gplus" data-text="I've found this awesome library on Android-Libs! @Android_Libs" data-url="{{ url('/lib/' . $oLib->slug, [], true) }}" data-share="gplus">
                    ...
                    <div class="panel-body padding-sm">
                        ...
                        @else
                            @foreach($oLib->getImages() as $sImage)
                                <a href="{{ asset('/assets/img/libs/' . $sImage . '.png', true) }}" data-lightbox="{{ str_random() }}" data-title="{{ $oLib->title }}"><img src="{{ asset('/assets/img/libs/' . $sImage . '.png', true) }}" class="img-responsive"></a>
                            @endforeach
                        @endif
                    </div> <!-- / .panel-body -->
                </div>
            ...
            <div class="panel-body padding-sm">
                 <div id="disqus_thread"></div>
                    <script type="text/javascript">
                        ...
                        var disqus_url = '{{ url('/lib/' . $oLib->slug, [], true) }}';
